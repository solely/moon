...
zend_class_entry *moon_component_http_message_session_sessionbaginterface_ce;
zend_class_entry *moon_component_http_message_session_storage_sessionstorageinterface_ce;
zend_class_entry *moon_component_errorhandler_formatter_formatterinterface_ce;
zend_class_entry *moon_component_http_message_session_attribute_attributebaginterface_ce;
zend_class_entry *moon_component_http_message_session_flash_flashbaginterface_ce;
...
zend_class_entry *moon_component_http_message_session_sessioninterface_ce;
...
zend_class_entry *moon_component_http_message_session_storage_handler_abstractsessionhandler_ce;
...
zend_class_entry *moon_component_http_message_session_attribute_attributebag_ce;
zend_class_entry *moon_component_http_message_session_storage_mockarraysessionstorage_ce;
zend_class_entry *moon_component_http_message_session_storage_nativesessionstorage_ce;
zend_class_entry *moon_component_http_message_session_storage_proxy_abstractproxy_ce;
zend_class_entry *moon_0__closure_ce;
zend_class_entry *moon_1__closure_ce;
zend_class_entry *moon_2__closure_ce;
zend_class_entry *moon_3__closure_ce;
zend_class_entry *moon_4__closure_ce;
zend_class_entry *moon_5__closure_ce;
zend_class_entry *moon_6__closure_ce;
zend_class_entry *moon_7__closure_ce;
...
zend_class_entry *moon_component_errorhandler_bootstrap_ce;
zend_class_entry *moon_component_errorhandler_dumper_ce;
zend_class_entry *moon_component_errorhandler_errorhandler_ce;
zend_class_entry *moon_component_errorhandler_exception_errorexception_ce;
zend_class_entry *moon_component_errorhandler_formatter_callbackformatter_ce;
zend_class_entry *moon_component_errorhandler_formatter_normalformatter_ce;
zend_class_entry *moon_component_errorhandler_handler_errorhandler_ce;
zend_class_entry *moon_component_errorhandler_handler_exceptionhandler_ce;
zend_class_entry *moon_component_errorhandler_helpers_ce;
zend_class_entry *moon_component_errorhandler_panel_ce;
zend_class_entry *moon_component_errorhandler_table_ce;
...
zend_class_entry *moon_component_http_message_session_attribute_namespacedattributebag_ce;
zend_class_entry *moon_component_http_message_session_flash_autoexpireflashbag_ce;
zend_class_entry *moon_component_http_message_session_flash_flashbag_ce;
zend_class_entry *moon_component_http_message_session_session_ce;
zend_class_entry *moon_component_http_message_session_sessionbagproxy_ce;
zend_class_entry *moon_component_http_message_session_sessionutils_ce;
zend_class_entry *moon_component_http_message_session_storage_handler_memcachedsessionhandler_ce;
zend_class_entry *moon_component_http_message_session_storage_handler_migratingsessionhandler_ce;
zend_class_entry *moon_component_http_message_session_storage_handler_nativefilesessionhandler_ce;
zend_class_entry *moon_component_http_message_session_storage_handler_nullsessionhandler_ce;
zend_class_entry *moon_component_http_message_session_storage_handler_pdosessionhandler_ce;
zend_class_entry *moon_component_http_message_session_storage_handler_redissessionhandler_ce;
zend_class_entry *moon_component_http_message_session_storage_handler_sessionhandlerfactory_ce;
zend_class_entry *moon_component_http_message_session_storage_handler_strictsessionhandler_ce;
zend_class_entry *moon_component_http_message_session_storage_metadatabag_ce;
zend_class_entry *moon_component_http_message_session_storage_mockfilesessionstorage_ce;
zend_class_entry *moon_component_http_message_session_storage_phpbridgesessionstorage_ce;
zend_class_entry *moon_component_http_message_session_storage_proxy_sessionhandlerproxy_ce;
...
static PHP_MINIT_FUNCTION(moon)
{
	...
	zephir_module_init();
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_SessionBagInterface);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_SessionStorageInterface);
	ZEPHIR_INIT(Moon_Component_ErrorHandler_Formatter_FormatterInterface);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Attribute_AttributeBagInterface);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Flash_FlashBagInterface);
	...
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_SessionInterface);
	...
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_Handler_AbstractSessionHandler);
	...
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Attribute_AttributeBag);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_MockArraySessionStorage);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_NativeSessionStorage);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_Proxy_AbstractProxy);
	...
	ZEPHIR_INIT(Moon_Component_ErrorHandler_Bootstrap);
	ZEPHIR_INIT(Moon_Component_ErrorHandler_Dumper);
	ZEPHIR_INIT(Moon_Component_ErrorHandler_ErrorHandler);
	ZEPHIR_INIT(Moon_Component_ErrorHandler_Exception_ErrorException);
	ZEPHIR_INIT(Moon_Component_ErrorHandler_Formatter_CallbackFormatter);
	ZEPHIR_INIT(Moon_Component_ErrorHandler_Formatter_NormalFormatter);
	ZEPHIR_INIT(Moon_Component_ErrorHandler_Handler_ErrorHandler);
	ZEPHIR_INIT(Moon_Component_ErrorHandler_Handler_ExceptionHandler);
	ZEPHIR_INIT(Moon_Component_ErrorHandler_Helpers);
	ZEPHIR_INIT(Moon_Component_ErrorHandler_Panel);
	ZEPHIR_INIT(Moon_Component_ErrorHandler_Table);
	...
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Attribute_NamespacedAttributeBag);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Flash_AutoExpireFlashBag);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Flash_FlashBag);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Session);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_SessionBagProxy);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_SessionUtils);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_Handler_MemcachedSessionHandler);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_Handler_MigratingSessionHandler);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_Handler_NativeFileSessionHandler);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_Handler_NullSessionHandler);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_Handler_PdoSessionHandler);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_Handler_RedisSessionHandler);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_Handler_SessionHandlerFactory);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_Handler_StrictSessionHandler);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_MetadataBag);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_MockFileSessionStorage);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_PhpBridgeSessionStorage);
	ZEPHIR_INIT(Moon_Component_Http_Message_Session_Storage_Proxy_SessionHandlerProxy);
	...
	ZEPHIR_INIT(moon_2__closure);
	ZEPHIR_INIT(moon_3__closure);
	ZEPHIR_INIT(moon_4__closure);
	ZEPHIR_INIT(moon_5__closure);
	ZEPHIR_INIT(moon_6__closure);
	ZEPHIR_INIT(moon_7__closure);
...
static PHP_RINIT_FUNCTION(moon)
{
	...
	zephir_initialize_memory(moon_globals_ptr);
		...
		zephir_init_static_properties_Moon_Component_ErrorHandler_Dumper(TSRMLS_C);
