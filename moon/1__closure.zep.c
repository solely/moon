...
ZEPHIR_INIT_CLASS(moon_1__closure) {
	...
	zend_declare_property_null(moon_1__closure_ce, SL("error"), ZEND_ACC_PUBLIC|ZEND_ACC_STATIC);
...
PHP_METHOD(moon_1__closure, __invoke) {
	...
	ZEPHIR_MM_GROW();
	zephir_read_static_property_ce(&error, moon_1__closure_ce, SL("error"), PH_NOISY_CC);
